    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/home" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">OpticalMS</span>
            </a>
            ...
            <div class="dropdown">
                <button type="button" class="btn btn-outline-secondary" data-bs-toggle="dropdown" aria-expanded="false" data-bs-offset="0,10">
                ...
                <ul class="dropdown-menu">
                    ...
                    <!-- category title, set "categorized" variable to true -->
                      ...
                      @foreach ($category['items'] as $item)
                        <li><a wire:click.prevent="$set('page', '{{ $item['link'] }}')" class="dropdown-item {{ $this->is_active($item['link']) }}" href="#"><i class="bi bi-{{ $item['icon'] }}"></i> {{ $item['title'] }}</a></li>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                        ...
                        <img src="{{ asset('temp-profile-gradient.png') }}" alt="Profile" class="rounded-circle">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="home?page=profile&user_id={{ Auth::user()->id }}">
